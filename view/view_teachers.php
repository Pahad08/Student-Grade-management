                        ...
                        <table id="table">
                            ...
                            <tr class="row">
                                ...
                                <td class="data data-img"><img
                                        src="../profile_pics/<?php echo $teacher['profile_pic']  ?>" id="profile-pic">
                                </td>
                                <td class="data action">
                                    ...
                                    <button class="btn-edit">
                                        <a
                                            href=<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . "?teacher_id=" . $teacher['teacher_id']) ?>><img
                ...
                <div class="form-body">
                    ...
                    <form id="edit-teacherform" enctype="multipart/form-data" action="../ajax/edit_teacher.php">
                        ...
                        <input type="text" name="teacher-id" id="teacher-id"
                            value="<?php echo $teacher['teacher_id'] ?>" hidden>
