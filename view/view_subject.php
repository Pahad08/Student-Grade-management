                            ...
                            <table id="table-subject">
                                ...
                                <?php while ($subjects = $get_subjects->fetch_assoc()) { ?>
                                    <tr class="subject-row">
                                        ...
                                        <td class="subject-data description"><?php echo $subjects['description']  ?></td>
                                        <td class="subject-data action">
                                            ...
                                            <button class="btn-edit">
                                                <a href=<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . "?sub_id=" . $subjects['subject_id']) ?>><img src="../images/edit.png" alt="Edit" class="edit-sub"></a>
                                            </button>
                                        </td>
