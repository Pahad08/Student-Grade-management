                    ...
                    <div class="table-body" style="padding: 4px;">
                            ...
                            <?php while ($students = $get_students->fetch_assoc()) { ?>
                                <tr class="row">
                                    ...
                                    <td class="data action">
                                        <a class="view" href="../edit_grade.php?student=<?php echo $students['account_id'] ?>">
                        ...
                        <div class="pagination">
                            ...
                            <ul class="pagination-body">
                                ...
                                <li id="next">
                                    <a <?php echo ($page_num == $total_pages) ? "" : "href=" . htmlspecialchars($_SERVER['PHP_SELF'] . "?page_num={$next_page}&sec=A"); ?>>Next</a>
                                </li>
                            </ul>
